...
namespace Uppgift2
{
    public class DataAccess
    {
        ...
        private static string connectionString = "Data Source=serveruppgift2.database.windows.net;Initial Catalog=DbUppgift2;Persist Security Info=True;User ID=Maria;Password=#######";
